        ...
        <div v-else class="slider">
            ...
            <div class="slider-info">
                ...
                <div class="slider-links">
                    <a href="/products" class="products-btn">продукты</a>
                    <a href="/contact/us" class="contact-us-btn">связаться с нами</a>
                </div>
            </div>
        ...
        <div class="about-us-box">
            <div class="about-us-content">
                <div class="about-us-info">
                    ...
                    <p>
                        Ishtar — дочерняя компания более крупного холдинга Barus Holding Group, основанного в 2007 году.
                        Эта
                        группа занимается поставками и торговлей различными видами нефтепродуктов, нефтехимической
                        продукции
                        и полезных ископаемых. Группа имеет более чем 10-летний блестящий опыт работы в сфере
                        международной
                        торговли и осуществляет свою деятельность в Европе и Азии. Ishtar — один из крупнейших игроков в
                        регионе, экспортируя различные товары в такие страны, как Испания, Германия, Нидерланды,
                        Россия, Китай, Индия, страны СНГ, Ирак, Пакистан, Оман, Катар и ОАЭ. Эта группа
                        сотрудничает с крупнейшими мировыми производителями и реальными производителями в различных
                        отраслях,
                        таких как нефтяная, газовая и горнодобывающая, и имеет разнообразную товарную корзину...
                    </p>
    ...
    <div class="mission-statement">
        <div class="mission-statement-box">
            <div class="mission-statement-content">
                <p>
                    Наш главный приоритет — удовлетворение растущих потребностей наших клиентов.
                    Мы ценим разнообразие как фактор инноваций и роста.
                </p>
            </div>
        </div>
    </div>
