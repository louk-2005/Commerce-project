...
.dropdown-menu {
    ...
    padding: 10px;
    top: 100%;
    right: 0; /* برای راست‌چین کردن منو */
    background: #3e4e6e;
    min-width: 180px;
...
.search-box form > div {
    display: flex;
    width: 100%;
    flex-direction: row-reverse; /* برای راست‌چین کردن input و دکمه */
}

#search-input {
    padding: 7px 12px;
    border: none;
    border-radius: 4px 0 0 4px; /* تغییر برای راست‌چین */
    outline: none;
    font-size: 16px;
    width: 200px;
...
button[type="submit"] {
    ...
    padding: 0 15px;
    cursor: pointer;
    border-radius: 0 4px 4px 0; /* تغییر برای راست‌چین */
    display: flex;
    align-items: center;
