            ...
            <div class="footer-content" v-for="contact in contacts" :key="contact.id">
                <div class="footer-row" v-if="contact.name === 'CENTRAL_OFFICE'">
                    ...
                    <div class="footer-quick-access">
                        <p>Быстрый доступ</p>
                        <ul>
                            <li @click="goPage('/')">Главная</li>
                            <li @click="goPage('/products')">Товары</li>
                            <li @click="goPage('/contact/us')">Контакты</li>
                            <li @click="goPage('/about')">О нас</li>
                        </ul>
                    </div>
                ...
                <div class="social-link" v-if="contact.name === 'CENTRAL_OFFICE'">
                    <p class="footer-header">
                        Следите за нами в следующих сетях:
                    </p>
...
.footer-box {
    width: 70%;
    margin: 0 auto;
    /* Use column direction to stack footer-content nicely if more than one */
    display: flex;
...
.footer-content {
    /* Since you loop only one CENTRAL_OFFICE item, full width */
    width: 100%;
}
...
/* Logo container to center logo vertically */
.footer-logo {
    display: flex;
...
.social-icon {
    ...
    height: 42px;
    border-radius: 50%;
    background-color: #374151; /* خاکستری تیره */
    color: #fbbf24;
    font-size: 22px;
